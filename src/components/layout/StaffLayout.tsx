...
export const StaffLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gym-black flex flex-col md:flex-row text-gym-white">
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-50 w-72 bg-gym-dark border-r border-gym-border flex flex-col transition-transform duration-300 ease-in-out ${
